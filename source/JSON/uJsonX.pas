...
type
  ...
  AJsonXSerialize = class(TCustomAttribute)
  public
    FSerialize: Boolean;
    constructor Create(const ASerialize: Boolean);
  end;
  ...
  public
    ...
    class function  Parser(Obj: TObject; JsonStr: string; SysParams: TJsonXSystemParameters = Nil; SysStatus: TJsonXSystemStatus = Nil): Boolean; overload;
    class function  Parser(Obj: TObject; JsonStr: PString; SysParams: TJsonXSystemParameters = Nil; SysStatus: TJsonXSystemStatus = Nil): Boolean; overload;
...
constructor AJsonXSerialize.Create(const ASerialize: Boolean);
begin
...
class function TJsonX.Parser(Obj: TObject; JsonStr: string; SysParams: TJsonXSystemParameters; SysStatus: TJsonXSystemStatus): Boolean;
begin
  var Watch := TStopWatch.StartNew;
  var Flag := InitSysObjects(SysParams, SysStatus);
  if (SysStatus <> Nil) then SysStatus.Clear;
...
class function TJsonX.Parser(Obj: TObject; JsonStr: PString; SysParams: TJsonXSystemParameters; SysStatus: TJsonXSystemStatus): Boolean;
begin
  var Watch := TStopWatch.StartNew;
  var Flag := InitSysObjects(SysParams, SysStatus);
  if (SysStatus <> Nil) then SysStatus.Clear;
